        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
              Formez {{ agentName }} avec vos contenus de marque
            </p>
          </div>
          ...
          <div class="flex items-center space-x-3">
            <button
              ...
              class="inline-flex items-center px-4 py-2 border border-gray-200 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 transition-colors"
            >
            ...
            <button
              ...
              :disabled="loading || saving"
              class="inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg disabled:opacity-50 btn-primary"
            >
              <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="px-6 lg:px-8 py-6">
        ...
        <div class="flex items-center">
          ...
          <div class="flex-1">
            ...
            <p class="text-sm text-gray-600">
              {{ uploadProgress > 0 ? 'Telechargement de vos fichiers' : `${agentName} est en train de lire et memoriser vos nouveaux documents` }}
            </p>
            <div v-if="uploadProgress > 0" class="mt-2 bg-gray-200 rounded-full h-2">
              <div
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div class="stats-card">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500">Sources actives</p>
          </div>
        </div>
        ...
        <div class="stats-card">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500">Mots analysés</p>
          </div>
        </div>
        ...
        <div class="stats-card">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500">Types de sources</p>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="add-source-card" @click="handleOpenFileUpload">
          ...
          <p class="text-sm text-gray-500">PDF, Docx, CSV</p>
          <div class="mt-3 flex items-center text-gray-700 text-sm font-medium">
            Importer
        ...
        <div class="add-source-card" @click="handleShowWebsiteModal">
          ...
          <p class="text-sm text-gray-500">Pages, Blog, Politiques</p>
          <div class="mt-3 flex items-center text-gray-700 text-sm font-medium">
            Analyser
            <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
        ...
        <div class="add-source-card" @click="handleShowTextModal">
          ...
          <p class="text-sm text-gray-500">FAQ, routines, ingredients</p>
          <div class="mt-3 flex items-center text-gray-700 text-sm font-medium">
            Rediger
            <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
      ...
      <div class="mb-6 bg-white border border-gray-200 rounded-xl p-6">
        <div class="flex items-center justify-between">
          <div>
            <h3 class="text-lg font-semibold text-gray-900 mb-2">Memoire actuelle de {{ agentName }}</h3>
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
              ...
              <div class="flex items-center">
                ...
                <span class="text-gray-700">
                  ...
                  <span class="font-semibold">{{ planDetails.quotasStatus.indexablePages.limit === -1 ? '&#8734;' : planDetails.quotasStatus.indexablePages.limit }}</span> pages web analysees
                </span>
              </div>
              <div class="flex items-center">
                <div class="w-3 h-3 rounded-full mr-2 bg-gray-500"></div>
                <span class="text-gray-700"><span class="font-semibold">{{ agentName }} {{ planDetails.name === 'growth' ? 'Pro' : 'Decouverte' }}</span></span>
              </div>
            </div>
          </div>
          <div v-if="!canUploadDocument" class="text-right">
            <p class="text-sm text-orange-600 font-medium mb-2">Limite atteinte</p>
            <a href="/billing" class="text-sm text-gray-900 hover:text-gray-700 font-medium underline">
              Augmenter les capacites de {{ agentName }}
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="card-modern mb-6">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
          ...
          <div class="flex-1 max-w-lg">
            <div class="relative">
              ...
              <input
                ...
                class="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-colors"
              >
            </div>
          </div>
          ...
          <div class="flex items-center space-x-4">
            <select v-model="selectedType" class="input-modern border-gray-200 focus:border-gray-900 focus:ring-gray-900">
            ...
            <select v-model="selectedStatus" class="input-modern border-gray-200 focus:border-gray-900 focus:ring-gray-900">
      ...
      <div class="card-modern">
        <div class="flex items-center justify-between p-6 border-b border-gray-200">
          ...
          <div class="flex items-center space-x-4">
            ...
            <button
              ...
              :disabled="loading || saving"
              class="text-gray-700 hover:text-gray-900 text-sm font-medium disabled:opacity-50 transition-colors"
            >
            ...
            <div class="flex items-start justify-between">
              <div class="flex items-start space-x-4 flex-1">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center text-xs text-gray-500 space-x-4">
                    ...
                    <span v-if="item.linkedAgents?.length">Lie a {{ item.linkedAgents.length }} Vendeuse(s) IA</span>
              ...
              <div class="flex items-center space-x-2 ml-4">
                ...
                <button
                  ...
                  :disabled="saving"
                  class="action-button text-gray-600 hover:text-gray-900 hover:bg-gray-100"
                  title="Modifier"
                >
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
        ...
        <div v-else class="text-center py-12 px-6">
          <div class="knowledge-empty-illustration">
            <div class="mx-auto h-16 w-16 text-gray-400 mb-4 bg-gray-100 rounded-2xl flex items-center justify-center">
          ...
          <!-- Guidance card -->
          <div v-if="!hasActiveFilters" class="mt-6 max-w-lg mx-auto bg-gray-900 rounded-xl p-6 text-left">
            <h4 class="text-white font-medium mb-2">À quoi sert la base de connaissances ?</h4>
            <p class="text-gray-400 text-sm mb-3">
              La base de connaissances permet à {{ agentName }} de connaître votre marque, vos produits et vos conseils. Plus elle en sait, meilleures sont ses recommandations.
            </p>
            <ul class="text-gray-400 text-sm space-y-1.5">
              <li class="flex items-start">
                <svg class="w-4 h-4 text-gray-500 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                Importez vos fiches produits, FAQ ou guides
              </li>
              <li class="flex items-start">
                <svg class="w-4 h-4 text-gray-500 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                Indexez votre site web automatiquement
              </li>
              <li class="flex items-start">
                <svg class="w-4 h-4 text-gray-500 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                Redigez des conseils ou routines personnalises
              </li>
            </ul>
          </div>
          ...
          <div class="mt-6">
            <button
              ...
              @click="handleQuickAddKnowledge"
              class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-gray-900 hover:bg-gray-800 transition-colors"
            >
              <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
              </svg>
              Ajouter votre premiere connaissance
            </button>
            <button
              v-else
              @click="clearFilters"
              class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-gray-700 bg-gray-100 hover:bg-gray-200 transition-colors"
            >
              Effacer les filtres
            </button>
          </div>
      ...
      <div class="modal-content modal-large">
        ...
        <div class="modal-body">
          <div class="bulk-upload-zone" @click="triggerBulkFileInput" @drop="handleBulkFileDrop" @dragover.prevent @dragenter.prevent>
            ...
            <p class="text-xl font-medium text-gray-900">Glissez jusqu'a 10 fichiers ici</p>
            <p class="text-sm text-gray-500 mt-1">ou cliquez pour selectionner</p>
          ...
          <div v-if="bulkUploadQueue.length > 0" class="mt-6">
            <div class="flex items-center justify-between mb-3">
              <h4 class="text-sm font-medium text-gray-900">{{ bulkUploadQueue.length }} fichier(s) selectionne(s)</h4>
          ...
          <div class="space-y-4">
            <div>
              ...
              <input
                ...
                type="text"
                placeholder="Ex: Routine anti-age, Guide teintes fond de teint, Conseils peaux sensibles..."
...
2. Tonique equilibrant
3. Serum a l'acide hyaluronique
4. Creme hydratante legere
...
- Sous-ton chaud : teintes dorees, peche
- Sous-ton froid : teintes rosees, beiges froids
- Sous-ton neutre : teintes equilibrees"
                class="input-modern w-full resize-none"
              ></textarea>
              <p class="text-xs text-gray-500 mt-1">{{ quickAddForm.content.length }} caracteres</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                type="text"
                placeholder="Ex: skincare, routine, peau-mixte, anti-age, maquillage (separes par des virgules)"
                class="input-modern w-full"
              >
          ...
          <div class="space-y-6">
            ...
            <div>
              ...
              <p class="text-xs text-gray-500 mt-1">
                Nous recupererons automatiquement toutes les pages de votre site
              </p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                type="text"
                placeholder="Ex: Site principal, Blog beaute, E-shop..."
                class="input-modern w-full"
                :disabled="saving"
              >
              <p class="text-xs text-gray-500 mt-1">
                Ce nom sera utilise comme prefixe pour tous les documents crees
              </p>
            </div>
            ...
            <div class="space-y-4">
              ...
              <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <div class="flex items-start">
                  ...
                  <div class="flex-1">
                    <h5 class="text-sm font-medium text-gray-900 mb-1">Indexation intelligente</h5>
                    <p class="text-sm text-gray-600 mb-3">
                      Notre systeme recupere automatiquement toutes les pages de votre site via le sitemap.xml
                    ...
                    <div class="space-y-2">
                      <label class="flex items-center text-sm">
                        <input
                          ...
                          type="checkbox"
                          class="rounded border-gray-300 text-gray-900 focus:ring-gray-900 mr-2"
                          :disabled="saving"
                        >
                        <span class="text-gray-700">
                          Analyser toutes les pages decouvertes (recommande)
                        </span>
                      </label>

                      <div v-if="!websiteForm.includeSubpages" class="bg-yellow-50 border border-yellow-200 rounded p-2 ml-6">
                        <p class="text-xs text-yellow-700">
                          Seule la page principale sera indexee si cette option est desactivee
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <!-- Plan Limits Info -->
              <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <h5 class="text-sm font-medium text-gray-900 mb-2">Capacites de {{ agentName }} {{ planDetails.name === 'growth' ? 'Pro' : 'Decouverte' }}</h5>
                <div class="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <span class="text-gray-600">Documents disponibles:</span>
                    <span class="ml-2 font-medium">
                      {{ documentsRemaining === -1 ? 'Illimite' : documentsRemaining }}
                    </span>
                  </div>
                  <div>
                    ...
                    <span class="ml-2 font-medium">
                      {{ planDetails.name === 'starter' ? '500' :
                         planDetails.name === 'growth' ? '2000' : 'Illimite' }}
                    </span>
                  </div>
                </div>
                <p class="text-xs text-gray-500 mt-2">
                  Chaque page recuperee creera un document separe dans votre base de connaissances
                </p>
              </div>
              ...
              <div class="opacity-50">
                <label class="flex items-center text-sm text-gray-400">
                  ...
                  >
                  <span>Mise a jour automatique (quotidienne) - Bientot disponible</span>
                </label>
              </div>
            </div>
          </div>
          ...
          <div class="space-y-4">
            <div>
              ...
              <input
                ...
                type="text"
                placeholder="FAQ Skincare, Conseils Maquillage, Guide Anti-age..."
                class="input-modern w-full"
              >
            </div>
            ...
            <div>
              ...
              <select v-model="textForm.type" class="input-modern w-full">
                ...
                <option value="guide">Guide/Tutoriel beaute</option>
                <option value="product-info">Informations produits</option>
              </select>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows="10"
                placeholder="Redigez ou collez votre texte ici...

Exemple routine skincare :
Pour une peau eclatante, suivez cette routine quotidienne :
1. Nettoyage doux matin et soir
2. Tonique hydratant
3. Serum vitamin C le matin
4. Creme hydratante adaptee a votre type de peau
5. Protection solaire obligatoire le matin

Exemple conseils maquillage :
Pour choisir son fond de teint :
- Testez toujours sur la machoire
- Choisissez selon votre sous-ton (chaud/froid/neutre)
- Adaptez la couvrance a vos besoins
- N'oubliez pas le primer pour une tenue optimale"
      ...
      <div class="modal-content modal-large">
        <div class="modal-header">
          <h3 class="modal-title">
            {{ editForm.contentType === 'file' ? 'Modifier les metadonnees du fichier' : 'Modifier le contenu' }}
          </h3>
          ...
          <div class="space-y-4">
            ...
            <div v-if="editForm.contentType !== 'file'">
              ...
              <textarea
                ...
                class="input-modern w-full resize-none"
              ></textarea>
              <p class="text-xs text-gray-500 mt-1">{{ editForm.content.length }} caracteres</p>
            </div>
            ...
            <div v-else class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <div class="flex">
                ...
                <div>
                  <h4 class="text-sm font-medium text-yellow-800 mb-1">Fichier importe</h4>
                  <p class="text-sm text-yellow-700">
                    Le contenu de ce fichier a ete extrait automatiquement.
            ...
            <div class="flex items-center">
              ...
              <label for="editActive" class="ml-2 text-sm text-gray-700">
                Document actif (utilise par {{ agentName }})
              </label>
            </div>
          </div>
        </div>
    ...
    <div v-if="showViewModal" class="modal-overlay" @click.self="showViewModal = false">
      <div class="modal-content modal-large">
        <div class="modal-header">
          <h3 class="modal-title">Details du document</h3>
          ...
          <div class="space-y-6">
            ...
            <div class="flex items-start justify-between">
              ...
              <button
                ...
                class="inline-flex items-center px-3 py-2 border border-gray-200 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors"
              >
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                </svg>
            ...
            <!-- Source Info -->
            <div v-if="currentViewDocument.sourceFile || currentViewDocument.sourceUrl" class="p-4 bg-gray-50 rounded-lg">
              <h5 class="text-sm font-medium text-gray-900 mb-2">Source</h5>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="text-center">
            ...
            <h4 class="text-lg font-medium text-gray-900 mb-2">Etes-vous sur ?</h4>
            <p class="text-gray-600 mb-4">
              Vous etes sur le point de supprimer definitivement le document :
            </p>
            ...
            <div class="bg-red-50 border border-red-200 rounded-lg p-3 mb-4">
              <p class="text-sm text-red-800">
                Cette action est irreversible. Le document et son fichier associe seront supprimes definitivement.
              </p>
            </div>
          </div>
        </div>
    ...
    <div
      ...
      class="fixed bottom-4 right-4 bg-green-600 text-white px-6 py-3 rounded-lg shadow-sm z-50 transform transition-all duration-300"
    >
      <div class="flex items-center">
        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div
      v-if="error"
      class="fixed bottom-4 right-4 bg-red-600 text-white px-6 py-3 rounded-lg shadow-sm z-50 transform transition-all duration-300"
    >
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const getTypeIconClass = (type: string): string => {
  const classes: Record<string, string> = {
    ...
    url: 'bg-amber-50 text-amber-600'
  }
...
.input-modern {
  @apply px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-colors text-sm;
}

.btn-primary {
  @apply px-4 py-2 text-white text-sm font-medium rounded-lg disabled:opacity-50 transition-colors;
...
.btn-secondary {
  @apply px-4 py-2 border border-gray-200 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors;
}
...
.stats-card {
  @apply bg-white rounded-xl shadow-sm border border-gray-200 p-5 flex items-center space-x-4;
}
...
.add-source-card {
  @apply bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center cursor-pointer transition-all hover:border-gray-300 hover:bg-gray-50;
}
...
.modal-content {
  @apply bg-white rounded-xl shadow-sm max-w-lg w-full max-h-[90vh] overflow-y-auto;
}
...
/* FILE UPLOAD */
.file-upload-zone {
  @apply border-2 border-dashed border-gray-300 rounded-lg p-8 text-center cursor-pointer transition-colors hover:border-gray-400 hover:bg-gray-50;
}

.bulk-upload-zone {
  @apply border-2 border-dashed border-gray-300 rounded-lg p-12 text-center cursor-pointer transition-colors hover:border-gray-400 hover:bg-gray-50;
}
