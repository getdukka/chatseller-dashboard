  ...
  <div>
    ...
    <div v-if="registrationSuccess" class="bg-white py-8 px-6 shadow-xl rounded-xl border border-gray-100">
      <div class="text-center">
        ...
        <!-- Boutons pour ouvrir la boîte mail -->
        <div class="space-y-3 mb-6">
          <p class="text-sm text-gray-500 mb-4">Ouvrir votre boîte mail :</p>
          <div class="flex flex-col sm:flex-row gap-3 justify-center">
            <a 
              :href="getGmailUrl(form.email)"
              target="_blank"
              class="inline-flex items-center justify-center px-4 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-medium"
            >
            ...
            <a 
              ...
              target="_blank"
              class="inline-flex items-center justify-center px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium"
            >
              <svg class="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
